...
function CampaignsApi(apiClient) {
  ...
  _defineProperty(this, "assignCampaignMessageTemplate", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              returnType = Object;
              return _context.abrupt("return", _this.apiClient.callApi('/api/campaign-message-assign-templates/', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context2.abrupt("return", _this.apiClient.callApi('/api/campaigns/', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 12:
            case "end":
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context3.abrupt("return", _this.apiClient.callApi('/api/campaign-create-clones/', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 12:
            case "end":
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context4.abrupt("return", _this.apiClient.callApi('/api/campaign-send-jobs/', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 12:
            case "end":
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 3:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context5.abrupt("return", _this.apiClient.callApi('/api/campaigns/{id}/', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 12:
            case "end":
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context6.abrupt("return", _this.apiClient.callApi('/api/campaigns/{id}/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 13:
            case "end":
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 4:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context7.abrupt("return", _this.apiClient.callApi('/api/campaign-messages/{id}/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 13:
            case "end":
  ...
  _defineProperty(this, "getCampaignRelationships", /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(id, relatedResource) {
      var postBody, pathParams, queryParams, headerParams, formParams, authNames, contentTypes, accepts, returnType;
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 5:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context8.abrupt("return", _this.apiClient.callApi('/api/campaigns/{id}/relationships/{related_resource}/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 14:
            case "end":
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 4:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context9.abrupt("return", _this.apiClient.callApi('/api/campaign-send-jobs/{id}/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 13:
            case "end":
  ...
  _defineProperty(this, "getCampaignTags", /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(campaignId, opts) {
      var postBody, pathParams, queryParams, headerParams, formParams, authNames, contentTypes, accepts, returnType;
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 4:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context10.abrupt("return", _this.apiClient.callApi('/api/campaigns/{campaign_id}/tags/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 13:
            case "end":
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context11.abrupt("return", _this.apiClient.callApi('/api/campaigns/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 11:
            case "end":
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 5:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context12.abrupt("return", _this.apiClient.callApi('/api/campaigns/{id}/', 'PATCH', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 14:
            case "end":
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 5:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context13.abrupt("return", _this.apiClient.callApi('/api/campaign-messages/{id}/', 'PATCH', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 14:
            case "end":
  ...
  _defineProperty(this, "updateCampaignSendJob", /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(body, id) {
      var postBody, pathParams, queryParams, headerParams, formParams, authNames, contentTypes, accepts, returnType;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 5:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context14.abrupt("return", _this.apiClient.callApi('/api/campaign-send-jobs/{id}/', 'PATCH', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
            case 14:
            case "end":
