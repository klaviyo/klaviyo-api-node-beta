...
function MetricsApi(apiClient) {
  ...
  _defineProperty(this, "getMetricAggregate", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context2.abrupt("return", _this.apiClient.callApi('/api/metric-aggregates/', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              accepts = ['application/json'];
              returnType = Object;
              return _context3.abrupt("return", _this.apiClient.callApi('/api/metrics/', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType).then(function (response_and_data) {
                return response_and_data.data;
              }));
